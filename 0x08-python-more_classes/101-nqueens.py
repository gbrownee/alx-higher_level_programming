#!/usr/bin/python3
"""Module containing algorithm that resolves the N-Queen puzzle
using backtracking by computing all possible N-Queen solutions
"""
